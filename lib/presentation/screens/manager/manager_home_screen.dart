  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (_) => ManagerVehicleCubit()..load()),
        BlocProvider(create: (_) => ManagerFeedbackCubit()..load()),
      ],
      child: Scaffold(
          ...
          actions: [
            Builder(builder: (ctx) => IconButton(
              ...
              onPressed: () {
                ...
                if (_selectedIndex == 2) ctx.read<ManagerVehicleCubit>().load();
                if (_selectedIndex == 3) ctx.read<ManagerFeedbackCubit>().load();
              },
            )),
            IconButton(
        ...
        bottomNavigationBar: NavigationBar(
          ...
          destinations: const [
            ...
            NavigationDestination(icon: Icon(Icons.directions_car_rounded), label: 'Xe'),
            NavigationDestination(icon: Icon(Icons.star_rate_rounded), label: 'Đánh giá'),
          ],
        ),
